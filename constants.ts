...
export const TOKEN_3TWENTY_ADDRESS =
...
export const HEADER_LOGO_URL = "/logo.png";
...
export const DAPP_LIST = [
  ...
  },
  {
    name: "SushiSwap",
    description:
      "Swap, earn, stack yields, lend, borrow, leverage all on one decentralized platform.",
